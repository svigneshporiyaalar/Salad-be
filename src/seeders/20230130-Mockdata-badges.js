  ...
  async up(queryInterface, Sequelize) {
    return queryInterface.bulkInsert("badges", [
      ...
      },
      {
        ...
        onboarding: "yes",
        naturalProgression: "",
        trackParameter: "quantity",
        defaultTrack: "3 litres",
        possibleTrackRange: "0 - 5 litres" ,
        trackChangeValue: "0.5 litres",
        type: "Habit",
        media: null,
